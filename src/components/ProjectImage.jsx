...
export const ProjectImage = ({ src, alt, projectId }) => {
  ...
  // Fallback stylisé selon le projet en attendant l'ajout de l'image
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950/40 to-slate-950 p-4 text-center">
      ...
      <p className="text-[10px] text-slate-500 mt-0.5">Image à ajouter</p>
    </div>
  );
};
